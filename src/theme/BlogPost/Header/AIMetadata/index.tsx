...
export default function AIMetadata({ metadata }: AIMetadataDisplayProps): JSX.Element | null {
  // Early return if not AI-generated content
  ...
  try {
    ...
    if (metadata?.ai_models && !Array.isArray(metadata.ai_models)) {
      console.error('Invalid ai_models format');
      return (
        <Alert variant="destructive">
          <AlertTitle>Invalid Metadata</AlertTitle>
          <AlertDescription>
            There was an error displaying AI metadata. Please check the format.
          </AlertDescription>
        </Alert>
      );
    }
    ...
    console.error('Error rendering AI metadata:', error);
    return (
      <Alert variant="destructive">
        <AlertTitle>Error</AlertTitle>
        <AlertDescription>
          There was an error displaying AI metadata. Please check the console for details.
        </AlertDescription>
      </Alert>
    );
  }
